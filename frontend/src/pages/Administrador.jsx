...
import { Stacked, Foot, Button, SparkLine} from '../components';
      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">          
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400'>Ganancia total</p>
              <p className='text-2xl'>$190.950</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button 
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            ...
            >
              ...
              rounde-full p-4 hover:drop-shadow-xl'
              >
              {item.icon}
              </button>
              <p className='mt-3'>
        ...
        >
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$90.990</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$50.990</span>
                </p>
